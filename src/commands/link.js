...
DüzenlemeFormu.addComponents(YeniSistem)
  ...
  if(interaction.options.getSubcommand() === 'admin-liste') {
    ...
    const Sahip = new EmbedBuilder()
      ...
      .setFooter({text: client.user.username, iconURL: client.user.avatarURL()}) 
      .setTimestamp()
    if(interaction.user.id !== "824626594224013322" && interaction.user.id !== "824626594224013322" && interaction.user.id !== "824626594224013322" && interaction.user.id !== "824626594224013322") return await interaction.reply({embeds: [Sahip]})
