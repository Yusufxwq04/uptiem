...
async execute(client, interaction) { 
  ...
  const ParaYok = new EmbedBuilder()
    ...
    .setDescription(`${Emojis.Çarpı} Slot oynamak istediğin **${Miktar} AC** bakiyende bulunmuyor.`)
...
> ${Emojis.Para} Kazanılan para: **${Miktar*3} AC**  -  Kazanç: **${Miktar*3-Miktar} AC**
`)
      .setFooter({text: client.user.username, iconURL: client.user.avatarURL()}) 
      .setTimestamp()
...
> ${Emojis.Para} Kaybedilen para: **${Miktar} AC**
`)
      .setFooter({text: client.user.username, iconURL: client.user.avatarURL()}) 
      .setTimestamp()
