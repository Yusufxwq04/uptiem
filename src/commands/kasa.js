...
async execute(client, interaction) { 
  ...
  var Paralar = ['32', '33', '34', '35','36','37','38','39','40','48','54','60','65','85']
  ...
  const ParaYok = new EmbedBuilder()
    ...
    .setDescription(`${Emojis.Çarpı} Kasa açmak için **40 AC** gerekli.`)
...
> Kazanılan para: **${Kazanılan} AC**  -  Kazanç: **${Kazanılan-40} AC**
`)
    .setFooter({text: client.user.username, iconURL: client.user.avatarURL()}) 
    .setTimestamp()
