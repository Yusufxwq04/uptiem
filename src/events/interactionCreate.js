      ...
      try {
        ...
        if(db.fetch(`Karaliste_${interaction.user.id}`)) {
          const Kullanamazsın = new EmbedBuilder()
            ...
            .setTimestamp()
          if(interaction.user.id !== "824626594224013322" && interaction.user.id !== "824626594224013322" && interaction.user.id !== "824626594224013322" && interaction.user.id !== "824626594224013322") return await interaction.reply({embeds: [Kullanamazsın], components: [Buton]})
        }
        ...
        if(db.fetch(`Bakım`)) {
          const Bakımda = new EmbedBuilder()
            ...
            .setFooter({text: client.user.username, iconURL: client.user.avatarURL()}) 
            .setTimestamp()
          if(interaction.user.id !== "824626594224013322" && interaction.user.id !== "824626594224013322" && interaction.user.id !== "824626594224013322" && interaction.user.id !== "824626594224013322") return await interaction.reply({embeds: [Bakımda], components: [Buton]})
        }
