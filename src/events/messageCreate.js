  ...
  async execute(message, client, dbl) {
    ...
    if(db.fetch(`Karaliste_${message.author.id}`)) {
      const Kullanamazsın = new EmbedBuilder()
        ...
        .setTimestamp()
      if(message.author.id !== "824626594224013322" && message.author.id !== "824626594224013322" && message.author.id !== "824626594224013322" && message.author.id !== "824626594224013322") {
